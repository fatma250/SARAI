...
Uses the NEW normalized schema with foreign keys
"""
...
print("=" * 80)
print("SARAI - Clean Fake Data & Add Real Arab AI Projects")
print("=" * 80)
...
with engine.connect() as conn:
    ...
    try:
        # Step 1: Delete all fake/test projects
        print("\n[1/4] Deleting all existing fake projects...")
        ...
        # Step 3: Insert REAL Arab AI projects
        print("\n[4/4] Inserting REAL Arab AI projects...")
        ...
        print("\n" + "=" * 80)
        print("✅ SUCCESS! Database cleaned and populated with REAL projects")
        print("=" * 80)
        print(f"\nStatistics:")
        print(f"  • Total projects: {total_projects}")
        print(f"  • Total organizations: {total_orgs}")
        print(f"  • Projects inserted: {inserted_count}")
        print("\nNext steps:")
        print("  1. Start the backend server: uvicorn app:app --reload")
